...
public class ManagerService {
    public final static String PATH_SERVICE_CSV = "D:\\C0321G1_HuynhPhuocHau_Module2\\CasetudyModule2\\src\\data\\service.csv";
    public final static String PATH_VILLA_CSV = "D:\\C0321G1_HuynhPhuocHau_Module2\\CasetudyModule2\\src\\data\\villa.csv";
    public final static String PATH_HOUSE_CSV = "D:\\C0321G1_HuynhPhuocHau_Module2\\CasetudyModule2\\src\\data\\house.csv";
    public final static String PATH_ROOM_CSV = "D:\\C0321G1_HuynhPhuocHau_Module2\\CasetudyModule2\\src\\data\\room.csv";
            ...
            try {
                ...
                switch (chooseService) {
                    case 1:
                        ...
                        villaList.add(villa);
                        funcWriteRead.writeToFile(PATH_VILLA_CSV,villaList);
                        funcWriteRead.writeToFile(PATH_SERVICE_CSV, this.serviceList);
                        break;
                    case 2:
                        ...
                        houseList.add(house);
                        funcWriteRead.writeToFile(PATH_HOUSE_CSV,houseList);
                        funcWriteRead.writeToFile(PATH_SERVICE_CSV, this.serviceList);
                        break;
                    case 3:
                        ...
                        roomList.add(room);
                        funcWriteRead.writeToFile(PATH_ROOM_CSV,roomList);
                        funcWriteRead.writeToFile(PATH_SERVICE_CSV, this.serviceList);
                        break;
                    case 4:
                        System.out.println("Hiển thị danh sách service từ file: ");
                        List<Service> serviceList = funcWriteRead.readDataFromFile(PATH_SERVICE_CSV);
